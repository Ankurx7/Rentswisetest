...
const CreateProperty = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post(
                "${import.meta.env.VITE_SERVER}/api/v1/prop/create",
                formData,
                {
        ...
        >
            ...
            <div className="max-w-3xl mx-auto relative z-10">
                <div className="bg-white rounded-lg shadow-sm p-6 bg-opacity-90">
                    <div className="mb-6">
                        <h1 className="text-xl font-semibold text-gray-800">List Your Property</h1>
                        ...
                        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-3 py-2 text-xs bg-white rounded border border-gray-300"
                                />
                            </div>
                            <div>
